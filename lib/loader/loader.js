...
(function(global) {
  ...
  function makeDictionary() {
    var dict = new EmptyObject();
    dict['_dict'] = null;
    delete dict['_dict'];
    return dict;
  }

  var registry = makeDictionary();
  var stringRegistry = makeDictionary();
  var initializerRegistry = [];
  var seen = makeDictionary();
  ...
  requirejs.clear = function() {
    requirejs.entries = requirejs._eak_seen = registry = makeDictionary();
    requirejs.stringRegistry = makeDictionary();
